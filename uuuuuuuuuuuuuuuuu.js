...
(function(){
    ...
    widget_css += u_class + ' .gt_switcher{border-radius:4px;font-family:Arial;font-size:'+font_size+'pt;text-align:left;cursor:pointer;overflow:hidden;width:'+widget_width+'px;}';
    ...
    widget_css += u_class + ' .gt_switcher .gt_selected{background:var(--bg-footer);position:relative;}';
    widget_css += u_class + ' .gt_switcher .gt_selected a{border-radius:4px; border:1px solid '+switcher_border_color+';color:#ccc;padding:3px 5px;width:'+(widget_width - 2 * 5 - 2 * 1)+'px}';
    widget_css += u_class + ' .gt_switcher .gt_selected a:after{height:19px;display:inline-block;position:absolute;right:'+(flag_size < 20 ? 5 : 10)+'px;width:15px;background-position:50%;background-size:'+arrow_size+'px;background-image:url("data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'16\' height=\'16\' viewBox=\'0 0 285 285\'><path d=\'M282 76.5l-14.2-14.3a9 9 0 0 0-13.1 0L142.5 174.4 30.3 62.2a9 9 0 0 0-13.2 0L3 76.5a9 9 0 0 0 0 13.1l133 133a9 9 0 0 0 13.1 0l133-133a9 9 0 0 0 0-13z\' style=\'fill:'+escape(switcher_arrow_color)+'\'/></svg>");background-repeat:no-repeat;content:""!important;transition:all .2s}';
    widget_css += u_class + ' .gt_switcher .gt_selected a.open:after{transform:rotate(-180deg)}';
    widget_css += u_class + ' .gt_switcher .gt_selected a:hover{background:var(--bg-footer);}';
    widget_css += u_class + ' .gt_switcher .gt_current{display:none}';
    widget_css += u_class + ' .gt_switcher .gt_option{border-radius:4px;position:relative;border-left:1px solid '+switcher_border_color+';border-right:1px solid '+switcher_border_color+';border-'+switcher_open_direction+':1px solid '+switcher_border_color+';background-color:var(--bg-footer);display:none;width:'+(widget_width - 2 * 1)+'px;max-height:198px;height:0;box-sizing:content-box;overflow-y:auto;overflow-x:hidden;transition:height 0.5s ease-in-out}';
    widget_css += u_class + ' .gt_switcher .gt_option a{color:#ccc;padding:3px 5px}';
    widget_css += u_class + ' .gt_switcher .gt_option a:hover{background:#007aff;}';
