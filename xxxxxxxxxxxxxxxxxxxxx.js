...
(function(){
    ...
    widget_css += u_class + ' .gt_switcher{border-radius:4px;font-family:Arial;font-size:'+font_size+'pt;text-align:left;cursor:pointer;overflow:hidden;width:'+widget_width+'px;line-height:0}';
    ...
    widget_css += u_class + ' .gt_switcher .gt_selected a{border:1px solid '+switcher_border_color+';color:#ccc;padding:3px 5px;width:'+(widget_width - 2 * 5 - 2 * 1)+'px}';
