...
(function(){
    ...
    widget_css += u_class + ' .gt_switcher .gt_selected a{background:#1c1c9b; border:1px solid '+switcher_border_color+';color:'+switcher_text_color+';padding:3px 5px;width:'+(widget_width - 2 * 5 - 2 * 1)+'px}';
